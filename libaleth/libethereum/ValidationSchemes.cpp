...
string const c_freeStakingForkBlock = "freeStakingForkBlock";
string const c_betterPOSForkBlock = "betterPOSForkBlock";
string const c_reiDAOForkBlock = "reiDAOForkBlock";
