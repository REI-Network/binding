...
public:
    ...
    TransactionBase(u256 const& _value, u256 const& _gasPrice, u256 const& _gas, Address const& _dest, bytes const& _data, u256 const& _nonce, Secret const& _secret, boost::optional<AccessListStruct> _list = {}, boost::optional<uint64_t> _chainID = {}): m_type(MessageCall), m_nonce(_nonce), m_value(_value), m_receiveAddress(_dest), m_gasPrice(_gasPrice), m_gas(_gas), m_data(_data) { fillEIP2930Transaction(_list, _chainID); sign(_secret); }

    /// Constructs a signed contract-creation transaction.
    TransactionBase(u256 const& _value, u256 const& _gasPrice, u256 const& _gas, bytes const& _data, u256 const& _nonce, Secret const& _secret, boost::optional<AccessListStruct> _list = {}, boost::optional<uint64_t> _chainID = {}): m_type(ContractCreation), m_nonce(_nonce), m_value(_value), m_gasPrice(_gasPrice), m_gas(_gas), m_data(_data) { fillEIP2930Transaction(_list, _chainID); sign(_secret); }

    /// Constructs an unsigned message-call transaction.
    TransactionBase(u256 const& _value, u256 const& _gasPrice, u256 const& _gas, Address const& _dest, bytes const& _data, u256 const& _nonce = 0, boost::optional<AccessListStruct> _list = {}, boost::optional<uint64_t> _chainID = {}): m_type(MessageCall), m_nonce(_nonce), m_value(_value), m_receiveAddress(_dest), m_gasPrice(_gasPrice), m_gas(_gas), m_data(_data) { fillEIP2930Transaction(_list, _chainID); }

    /// Constructs an unsigned contract-creation transaction.
    TransactionBase(u256 const& _value, u256 const& _gasPrice, u256 const& _gas, bytes const& _data, u256 const& _nonce = 0, boost::optional<AccessListStruct> _list = {}, boost::optional<uint64_t> _chainID = {}): m_type(ContractCreation), m_nonce(_nonce), m_value(_value), m_gasPrice(_gasPrice), m_gas(_gas), m_data(_data) { fillEIP2930Transaction(_list, _chainID); }
...
protected:
    ...
    /// Try to fill params for EIP-2930 transaction.
    void fillEIP2930Transaction(const boost::optional<AccessListStruct> accessList, const boost::optional<uint64_t> chainID);
